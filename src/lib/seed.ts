...
export async function seedIfEmpty() {
  ...
  await db.systemConfig.createMany({
    data: [
      ...
      { key: 'ffmpeg_path', value: '/usr/bin/ffmpeg', description: 'Path to ffmpeg binary' },
      { key: 'ytdlp_path', value: '/home/z/.local/bin/yt-dlp', description: 'Path to yt-dlp binary' },
      { key: 'download_dir', value: '/home/z/my-project/download/videos', description: 'Directory for downloaded videos' },
      { key: 'fallback_video', value: '/home/z/my-project/download/standby/fallback.mp4', description: 'Fallback video for streams without a video' },
    ],
  });
  ...
  await db.video.create({
    data: {
      ...
      duration: 10,
      localPath: '/home/z/my-project/download/standby/fallback.mp4',
      status: 'cached',
      fileSize: 0,
